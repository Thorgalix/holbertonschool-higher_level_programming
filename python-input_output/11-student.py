...
class Student:
    ...
    This method updates the current object using the key-value pairs in the
    provided dictionary. Each key should correspond to a public attribute
    name of the Student instance. If a key exists in the dictionary, its
    value will overwrite the current attribute value.

    Args:
        json (dict): A dictionary containing attribute names as keys and
                     the values to update as values.
    """
