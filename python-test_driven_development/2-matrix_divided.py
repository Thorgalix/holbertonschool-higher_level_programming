#!/usr/bin/python3
"""
Module 2-matrix_divided: Contient une fonction qui divise
tous les éléments d'une matrice par un diviseur.
"""


def matrix_divided(matrix, div):
    """Divise tous les éléments d'une matrice par div et
    ...
    Returns:
        list: nouvelle matrice avec tous les éléments divisés
